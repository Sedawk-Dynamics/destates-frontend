        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-background/60 text-sm mb-4">
              Democratizing real estate investment through fractional ownership. Invest in premium properties with verified returns.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li><Link href="/plots" className="text-background/60 hover:text-primary transition-colors">Land Plots</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li><span className="text-background/60">Privacy Policy</span></li>
              <li><span className="text-background/60">Terms of Service</span></li>
              <li><span className="text-background/60">Disclaimer</span></li>
            </ul>
          </div>
        </div>
